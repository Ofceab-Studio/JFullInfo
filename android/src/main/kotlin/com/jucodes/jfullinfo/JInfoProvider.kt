...
class JInfoProvider(private val activity: Activity) :
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                val telecomManager: TelecomManager =
                    activity.getSystemService(TELECOM_SERVICE) as TelecomManager
    ...
    private fun getInfoModel(): JInfoModel {
        ...
        return JInfoModel(fANI, fSI, fAI)
    }
